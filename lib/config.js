...
const configBaseSchema = v.object({
  ...
  clean: v.either(
    v.enum('brunch-files', 'all', 'none'),
    v.array(v.enum('javascripts', 'javascript-maps', 'stylesheets', 'stylesheet-maps', 'templates', 'template-maps', 'compiled-assets', 'assets'))
  ).default('brunch-files'),
